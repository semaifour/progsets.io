...
public class ElasticInputProc extends Procedure {
	...
	public Map<String, String> settings(Procontext pc) {
		...
		if (ds == null) {
			ds = pc.appproperties().prop("procsets.proc.ielastic.default.datasource", "default");
		}
		//load default settings for the connector
		settings.putAll(pc.appproperties().propsWithPrefix("procsets.proc.ielastic.default.", true));
