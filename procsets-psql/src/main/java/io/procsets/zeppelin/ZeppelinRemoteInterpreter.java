...
public class ZeppelinRemoteInterpreter {
	...
	public void init() {
		try {
			...
			RemoteInterpreterServer interpreter = new RemoteInterpreterServer(appproperties.prop("procsets.zeppelin.interpreter.port", 8176));
			interpreter.start();
		} catch (Exception e) {
