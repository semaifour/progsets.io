...
public class MongoOutputProc extends Procedure {
	...
	public Map<String, String> settings(Procontext pc) {
		...
		if (ds == null) {
			ds = pc.appproperties().prop("progsets.proc.mongo.default.datasource", "default");
		}
		//load default settings for the connector
		settings.putAll(pc.appproperties().propsWithPrefix("progsets.proc.mongo.default.", true));
